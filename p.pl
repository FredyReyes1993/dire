...
print "Carnet: 5390-13-5752 <br>";
print "Nombre: BRIAN ALEXIS <br>";
print "Apellidos:CALIZ GONZ&Aacute;LEZ<br>";
print "Dire.casa: 12 CALLE 18-04 EDIFICIO D APARTAMENTO 304 COLONIA NIMAJUYU 1 ZONA 21, GU";
print "</div>";
...
print "Ciclo: 6<br>";
print "Mensual: Q. 800.00 <br>";
print "Tel.: 56996620";
print "Fecha Asig: 05/07/2022 10:20:49";
print "</div>";
print "<br>";
print "<br>";
print "<br>";
...
print "<div>";
print "<b>Usuario:</b> bcalisg <b>Contrase&ntilde;a</b> 354326Est$ (si no la ha cambiado) <b>Correo Electr&oacute;nico:</b> bcalisg&#64;miumg.edu.gt<br>";
